...
namespace GP2 
{
    GP2SwapChain::GP2SwapChain(GP2Device& deviceRef, VkExtent2D extent): 
        m_Device{ deviceRef }, 
    ...
    VkResult GP2SwapChain::AcquireNextImage(uint32_t* imageIndex) 
    {
        vkWaitForFences(
            m_Device.Device(),
            1,
    ...
    VkResult GP2SwapChain::SubmitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex) 
    {
    ...
    void GP2SwapChain::CreateSwapChain() 
    {
    ...
    void GP2SwapChain::CreateImageViews() 
    {
    ...
    void GP2SwapChain::CreateRenderPass() 
    {
    ...
    void GP2SwapChain::CreateFramebuffers() 
    {
    ...
    void GP2SwapChain::CreateSyncObjects() 
    {
    ...
    VkSurfaceFormatKHR GP2SwapChain::ChooseSwapSurfaceFormat(
    ...
    VkPresentModeKHR GP2SwapChain::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) 
    {
    ...
    VkExtent2D GP2SwapChain::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) 
    {
    ...
    VkFormat GP2SwapChain::FindDepthFormat() 
    {
