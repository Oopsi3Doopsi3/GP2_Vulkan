...
void main()
{
    ...
    oNormal = push.tessAlpha*pnNormal + (1.0-push.tessAlpha) * barNormal;
    ...
    vec3 finalPos = (1.0-push.tessAlpha)*barPos + push.tessAlpha*pnPos;
 gl_Position   = ubo.projection * push.modelMatrix * vec4(finalPos,1.0);
}